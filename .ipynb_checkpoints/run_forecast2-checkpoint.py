print("RUN_FORECAST START", __file__)
{
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "a2a1ca87-21c2-45ce-bc1d-d7a36651b0d5",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "✅ Forecast updated for 16 products (next 7 days).\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "id": "a4548e5f-8743-4bfe-b12d-bc847c84fa34",
   "metadata": {},
   "outputs": [],
   "source": []
  }
