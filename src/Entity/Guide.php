...
class Guide
{
    ...
    // ✨ FIX: This method now automatically calculates the step number
    public function addGuideStep(GuideStep $guideStep): static
    {
        if (!$this->guideSteps->contains($guideStep)) {
            ...
            // If the step doesn't have a number yet, give it one based on the count
            if ($guideStep->getStepOrder() === null) {
                // If this is the 1st step added, count is 1. If 2nd, count is 2.
